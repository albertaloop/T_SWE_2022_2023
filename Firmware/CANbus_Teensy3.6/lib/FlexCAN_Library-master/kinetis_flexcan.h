...
//(*(vuint32_t*)(FLEXCAN0_BASE+0xE0+(n<<2)))
...
#define FLEXCAN_set_rffn(ctrl2, rffn)                                          \
  ctrl2 = ((ctrl2) & ~FLEXCAN_CTRL2_RFFN) |                                    \
...
#define FLEXCAN_get_LTM(esr2_value)                                            \
  (((esr2_value) & (FLEXCAN_ESR2_LTM)) >> (FLEXCAN_ESR2_LTM_BIT_NO))
...
#define FLEXCAN_Set_IMEUP(imeur, imeup)                                        \
  imeur = (imeur & ~(FLEXCAN_IMEUR_IMEUP_MASK)) |                              \
...
#define FLEXCAN_Get_LostMBLocked(lrfr)                                         \
  ((lrfr & FLEXCAN_LRFR_LOSTRLP_MASK) >> (FLEXCAN_LRFR_LOSTRLP_BIT_NO))
...
#define FLEXCAN_RERRSYNR_check_BEn_Bit(errsynr, n)                             \
  (errsynr & FLEXCAN_RERRSYNR_BE##n##_MASK)
#define FLEXCAN_RERRSYNR_get_SYNDn(errsynr, n)                                 \
  (errsynr & FLEXCAN_RERRSYNR_SYND##n##_MASK)
#define FLEXCAN_RERRSYNR_check_SYNDn_Bit(errsynr, n)                           \
  ((errsynr & FLEXCAN_RERRSYNR_SYND##n##_MASK) >>                              \
