...
BME280_SPI::BME280_SPI(int8_t cspin, int8_t mosipin, int8_t misopin,
                       int8_t sckpin)
...
void BME280_SPI::setTempCal(float tcal) { tempcal = tcal; }
...
float BME280_SPI::getHumidity(void) { return humidity; }

// Gets the pressure in millibars
float BME280_SPI::getPressure_MB(void) { return pressure / 100.0F; }

// Gets the pressure in hectapascals
float BME280_SPI::getPressure_HP(void) { return pressure; }
...
void BME280_SPI::readHumidity(void) {
  ...
  v_x1_u32r = (((((adc_H << 14) - (((int32_t)cal_data.dig_H4) << 20) -
               ...
               (((((((v_x1_u32r * ((int32_t)cal_data.dig_H6)) >> 10) *
                    ...
                    (((v_x1_u32r * ((int32_t)cal_data.dig_H3)) >> 11) +
                     ((int32_t)32768))) >>
                   10) +
...

{
  ...
  cal_data.dig_H4 =
      (read8(BME280_DIG_H4_REG) << 4) | (read8(BME280_DIG_H4_REG + 1) & 0xF);
  cal_data.dig_H5 =
      (read8(BME280_DIG_H5_REG + 1) << 4) | (read8(BME280_DIG_H5_REG) >> 4);
...
int16_t BME280_SPI::readS16(byte reg) { return (int16_t)read16(reg); }

int16_t BME280_SPI::readS16_LE(byte reg) { return (int16_t)read16_LE(reg); }
